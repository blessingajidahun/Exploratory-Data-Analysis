...
o	Toys & Games ($8,217)
o	Sports & Outdoors ($6,689)
•	Young customers' highest spending categories:
o	Software & Apps ($8,061)
o	Sports & Outdoors ($7,921)
o	Groceries ($8,274)
...
	Young: 255
	Old: 230
o	Younger customers have higher representation in both income levels, making them a key target for premium and mid-range product offerings.
...
o	Customers might be dissatisfied with the quality of the products they receive, leading to frequent returns. However, further analysis (which will be explained later) reveals that products high customer satisfaction ratings were also returned, product quality may not be the reason for high return rate.
There could be mismatch between product descriptions and reality
o	If product descriptions (images, sizes, specifications) do not match the actual products, customers may return them.
o	Action: Improve product listings with clearer descriptions and real customer reviews.
Liberal Return Policy Encouraging Returns
o	If your store offers easy, free returns, customers might be buying and returning products without second thoughts.
Action: Review return policies to balance flexibility with business sustainability
...
•	Implication: Customers who used discounts returned more items than those who paid full price.
•	This suggests that discounts may encourage impulse buying, leading to more returns.
...
o	Customers with high social media influence spend the most (Avg. Purchase Amount = $284).
o	Customers with no social media influence spend the least ($263).
o	This suggests that social media plays a positive role in encouraging spending.
Medium Influence Group Also Spends More
o	Even customers with medium influence ($280.12) spend more than those with low influence ($272.50), reinforcing the impact of social media engagement.
Customers with High Social Media Influence Give More Ratings
o	The highest number of product ratings (268) comes from customers with high social media influence.
o	This suggests that socially engaged customers are more likely to leave reviews, possibly due to exposure to brand content and engagement with online communities.
Customers with No Social Media Influence Still Leave Many Ratings
o	The "None" group (247 ratings) is close to the "Low" (249 ratings) and "Medium" (236 ratings) groups.
o	This suggests that even customers who are not active on social media still leave reviews, possibly due to other forms of engagement (e.g., emails, website prompts).
Medium Influence Customers Give the Least Ratings
o	Customers with medium social media influence give the fewest product ratings (236).
o	This could indicate that casual social media users are not as motivated to leave reviews compared to highly engaged or non-social media users.
...
•	Since highly influenced customers are already reviewing, we should amplify this with campaigns like:
o	"Share your review and get a discount!"
o	"Post your purchase and tag us to win rewards!"

1.	TASK 6: Return rate and product quality: do product with low rating have higher return rates, which product category has the highest return rate, are dissatisfied customers more likely to return products
I used pivot table to carry out this analysis.
KEY INSIGHTS DISCOVERED:

Higher-Rated Products (4 & 5) Have the Most Returns:
o	Rating 5 has the highest total returns (211), followed by rating 4 (210).
o	Despite being high-rated, these products see substantial returns, likely due to unmet high expectations or buyer’s remorse.
Lower-Rated Products (1 & 2) Have a Moderate Return Rate:
o	Rating 1 (205 total returns) and Rating 2 (189) suggest that low-quality products also face returns, but not as much as high-rated ones.
o	This could indicate that customers expect issues with low-rated products and may hesitate to return them.
Return Rate Increases with Product Rating (1 → 5):
o	Lower-rated products (1, 2, 3) have fewer returns in category 2 (frequent returners).
o	Higher-rated products (4 & 5) have the most category 2 returns (72 & 63), meaning customers return them multiple times.

Higher Overall Returns for High-Rated Products (4 & 5):
o	Rating 5 has the highest total returns (211), followed by rating 4 (210).
o	Despite high quality, these products are still returned often—possibly due to high expectations.
...
o	Product Rating 1 has the highest wants-based return rate (59).
o	Impulsive returns are also highest for rating 4 (65), suggesting some customers regret impulsive high-quality purchases.
Need-Based Purchases Have the Highest Returns for Mid-Rated Products:
o	Product Rating 2 has the highest need-based returns (63), implying that essential products with mid-level quality don’t fully satisfy users.
Planned Purchases Have the Lowest Return Volatility:
o	Return rates for planned purchases remain stable across all ratings (43-59).
o	This suggests planned buyers make more informed and satisfactory decisions.
...
RECOMMENDATIONS
o	Enhance product durability, usability, or packaging to reduce dissatisfaction-driven returns.
o	Offer extended warranties or trials to build customer confidence
o	Since these essential products have high returns, focus on better materials, packaging, and durability.
o	To discourage impulse returns, implement a restocking fee or provide returns as store credit instead of cash refunds
